---
name: code-format
description: 代码格式规范，包括缩进、行长度、空行等。本规范定义了代码编写时的格式要求，确保代码风格统一、可读性强，适用于所有编程语言的代码编写场景。
priority: 3
...
本规范定义了代码编写时的格式要求，包括缩进、行长度、空行、导入顺序、括号和空格等基本格式规范。这些规范确保代码风格统一、可读性强，适用于所有编程语言的代码编写场景。遵循本规范可以提高代码的可维护性，减少因格式不一致导致的代码审查问题。
