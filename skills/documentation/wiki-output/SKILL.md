...
priority: 4
tags: ['documentation', 'wiki', 'output']
---
...
# 从文件转换
bash "$MERMAID_SCRIPT" diagram.mmd assets/
...
# 输出: assets/mermaid_20240129_123456.png
```
...
3. **批量转换**：调用 `scripts/mermaid_to_png.sh` 批量转换为 PNG 图片（白色背景）
