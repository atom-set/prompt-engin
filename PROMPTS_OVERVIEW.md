...
#### 3. 禁止行为清单 (`forbidden-behaviors.md`)
...
#### 4. 代码修改前的方案输出机制 (`solution-output.md`)
...
#### 5. 方案完整性判断标准 (`solution-completeness.md`)
...
#### 7. 例外情况处理 (`exception-handling.md`)
...
#### 9. 兼容性确认机制 (`compatibility-check.md`)
