...
[![Version](https://img.shields.io/badge/version-2.0.0-blue.svg)](https://github.com/your-org/your-repo)
...
```bash
# 克隆到本地目录（一次性操作）
git clone https://github.com/your-org/your-repo ~/skill-engine
```
