---
name: open-question-confirmation
description: 开放性问题确认规范，针对开放性问题必须通过询问方式与用户的理解达成一致
...
本文件定义了开放性问题确认规范，确保针对开放性问题必须通过询问方式与用户的理解达成一致，只有达成一致后才能给出方案。适用于所有涉及开放性问题的交互场景，包括需求确认、方案设计、技术选型等。
