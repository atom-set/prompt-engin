...
- **项目仓库**：GitHub 仓库（待补充）
- **文档**：查看项目 `docs/` 目录下的完整文档
- **快速开始**：查看 `QUICK_START.md` 快速开始指南
- **技能系统**：查看 `docs/milestones/V1_SKILL/` 目录下的技能系统指南
...
```mermaid
flowchart TD
    A[一、问题与痛点<br/>引起共鸣] --> B[二、工程初衷<br/>建立信任]
    B --> C[三、核心价值<br/>证明价值]
    C --> D[四、技术实现<br/>建立信心]
    D --> E[五、使用场景<br/>增强说服力]
    E --> F[六、未来展望<br/>展示能力]
